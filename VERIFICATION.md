...
| Immediate demo                           | Eleven dense synthetic runs across Mundial da Santa Marta and Free Ride in Santa Marta das Cortiças plus Secret Spot Sameiro, two bikes, seeded into a new rider workspace; sample GPX download | Pass                       |
| Final-user account flow                  | Production build opens on local-device Create account / Sign in; registration, hashed password storage, scoped workspace data and sign out covered by unit tests | Pass                       |
